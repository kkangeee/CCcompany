...
<div class="swiper-container">
	<div class="swiper-wrapper">
		...
		<div class="swiper-slide"> 
              <div class="card  box-shadow carddiv" onclick="location.href='productpage.jsp?idx=<%=bidx.get(i)%>'" style="width: 14rem; height:80%; margin: 10% 20% 10% 20%;">
...
<div style="margin-bottom:20%;" class="swiper-container">
	<div class="swiper-wrapper">
		...
		<% for(int i=0; i<8; i++){  %>
		<div class="swiper-slide"> 
              <div class="card  box-shadow carddiv"onclick="location.href='productpage.jsp?idx=<%=nidx.get(i)%>'" style="width: 14rem; height:80%; margin: 10% 20% 10% 20%;">
                <img class="card-img-top mx-auto" src="http://placehold.it/250X100" alt="Card image cap">
                <div class="card-body h-100">
